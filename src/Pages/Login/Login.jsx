...
const Login = () => {
    ...
    const handleGoogleSigUp = () => {
      googleSignUp()
        ...
        //   toast.success("Successfully SignUp using Google");
        })
        ...
        <div>
            ...
            <div className="max-w-sm w-full text-gray-600 space-y-5">
                ...
                >
                    ...
                    <input className="w-full px-4 py-2 text-white font-medium bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-600 rounded-lg duration-150" type="submit" value= 'Sign in' />
                </form>
                <button onClick={handleGoogleSigUp} className="w-full flex items-center justify-center gap-x-3 py-2.5 border rounded-lg text-sm font-medium hover:bg-gray-50 duration-150 active:bg-gray-100">
